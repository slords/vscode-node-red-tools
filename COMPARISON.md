...
```javascript
export default function func_process_data(msg, node, context, flow, global, env, RED) {
  msg.payload = msg.payload * 2;
  return msg;
}
```
...
export default function func_calculate(msg, node, context, flow, global, env, RED) {
  msg.payload = msg.payload * 2;
  return msg;
}
```
...
export default function func_process(msg, node, context, flow, global, env, RED) {
  msg.payload = msg.payload * 2;
  return msg;
}
